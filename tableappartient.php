...
$query = "SELECT appartient.*,etudiant.nom AS nomE,etudiant.prenom,groupe.nom
FROM((appartient

      INNER JOIN etudiant ON appartient.IDetudiant=etudiant.IDetudiant)
      INNER JOIN groupe ON appartient.IDgroupe=groupe.IDgroupe)order by nomE";
 ...
 <div class="col-sm-8">
  ...
  <?php
    ...
    ?>
      ...
      <a href="deleteappartient.php?IDetudiant=<?php echo $data["IDetudiant"]; ?>">Supprimer</a>
      </button>
